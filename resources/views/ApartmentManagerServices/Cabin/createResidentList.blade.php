...
<body>
    ...
    <div class="contus-container">
       <h2>Create Cabin Resident List</h2>
    </div>
    <br /><br /><br/>
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-sm-10">
            <form method="post" action="/apartmentManager/Cabin/storeResidentList">
                @csrf
    <div class="container1">
        <form method="post" action="">
            @csrf
            <div class="form-group row">
                <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter CabinNumber:</label><br/>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="cabinNumber" value="{{old('cabinNumber')}}"><br/><br/>
                </div><br/>
