...
<body>
    ...
    <div class="contus-container">
        <h2>Create Studio Resident List</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/apartmentManager/Studio/storeResidentList">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Studio Numner:</label><br/>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="studioNumber" value="{{old('studioNumber')}}"><br/><br/>
                        </div><br/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="roomNumber" value="{{old('roomNumber')}}"><br/>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="occupied" value="{{old('occupied')}}"/><br /> 
                        </div>
                    ...
                    <div class="form-group row">              
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="residentName" value="{{old('residentName')}}"/><br />  
                        </div>
                    ...
                    <div class="form-group row">             
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="emailId" value="{{old('emailId')}}"/><br />
                        </div>
                    ...
                    <div class="form-group row">             
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" name="leaseStartDate" value="{{old('leaseStartDate')}}"/><br />
                        </div>
                    ...
                    <div class="form-group row">             
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" name="leaseEndDate" value="{{old('leaseEndDate')}}"/><br />
                        </div>
