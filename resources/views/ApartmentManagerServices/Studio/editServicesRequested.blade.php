...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-sm-10">
            <form method="post" action="/apartmentManager/Studio/updateServicesRequested?emailId={{$emailId}}">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-12 text-center">
                        ...
                        <button type="cancel" onclick="window.location.href='{{ url('/apartmentManager/Studio/servicesRequested') }}'" class="btn btn-outline-secondary btn-lg">Cancel</button>&nbsp;
                    </div>
                </div>
            </form>
        </div>
