...
<body>
    ...
    <div class="contus-container">
       <h2>Create TownHouse Manage Services</h2>
    </div>
    <br /><br /><br/>
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-sm-10">
            <form method="post" action="/apartmentManager/TownHouse/storeManageServices">
                @csrf
            <div class="form-group row">
                <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Service Type:</label><br/>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="serviceType" value="{{old('serviceType')}}"><br/><br/>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="serviceHandlerName" value="{{old('serviceHandlerName')}}"><br/><br/>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="email" class="form-control" name="emailId" value="{{old('emailId')}}"><br/><br/>
