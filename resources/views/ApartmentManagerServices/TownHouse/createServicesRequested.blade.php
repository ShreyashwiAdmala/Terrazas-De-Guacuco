...
<body>
    ...
    <div class="contus-container">
        <h2>Create Services Requested</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/apartmentManager/TownHouse/storeServicesRequested">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Services Requested:</label><br/>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="servicesRequested" value="{{old('servicesRequested')}}"><br/><br/>
                        </div><br/>
                    ...
                    <div class="form-group row">              
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="apartmentNumber" value="{{old('apartmentNumber')}}"/><br />  
                        </div>
