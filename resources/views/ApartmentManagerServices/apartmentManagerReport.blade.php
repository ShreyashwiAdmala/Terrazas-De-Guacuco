    ...
    <body>
        ...
        <div class="report-row">
            <div class="report-column">
                <img src="../images/barChartAptManager.png" alt="report image not found" class="report-column" />
            </div>
            <div class="report-column">
                <img src="../images/pieChartAptManager.png" alt="report image not found" class="report-column" />
            </div>
        </div>
        <div class="report-data">
            <h3>Get to know more about Occupied Residents profiles</h3>
        </div>
        ...
        <table>
            ...
            @foreach($residentProfile as $residentProfile)
                <tr>
                    ...
                    <td>{{$residentProfile->name}}</td>
                    <td>{{$residentProfile->emailId}}</td>
                    <td>{{$residentProfile->phnumber}}</td>
                    <td>{{$residentProfile->dlnumber}}</td>
                    <td>{{$residentProfile->carnumplate}}</td>
                </tr>
            @endforeach
        </table>
        </div>
