  ...
  <div class="service-container3">
    <div class="service-row">
      <div class="service-column">
        <img src="../images/parking.jpeg" alt="Parking Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/buildingManager/parking">PARKING</a></h2>
    ...
    <div class="service-row">
      <div class="service-column">
        <img src="../images/manageResidents.jpeg" alt="Manage Residents Image not Found" class="image-service">
      </div>
      <div class="service-column2">
    ...
    <div class="service-row">
      <div class="service-column">
        <img src="../images/staffPortal.png" alt="Staff Portal Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/buildingManager/staffPortal">STAFF PORTAL</a></h2>
        <p>Handle and Manage the staff list of various services as in pool, garden, visitor, security and apartment.</p>
      </div>
    </div>
    <div class="service-row">
      <div class="service-column">
        <img src="../images/navigation.jpeg" alt="Map Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/maps">NAVIGATE</a></h2>
    ...
    <div class="service-row">
      ...
      <div class="service-column2">
        <h2><a href="/buildingManager/report">Dashboard</a></h2>
