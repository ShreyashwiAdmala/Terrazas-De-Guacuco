...
<body>
    ...
    <div class="contus-container">
        <h2>Create Apartment Staff List</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/buildingManager/storeAptStaffList">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="aptType" value="{{old('aptType')}}"/><br /> 
                        </div>
                        @if ($errors->has('aptType'))
                        <span class="field-error">{{ $errors->first('aptType') }}</span><br/>
                        @endif  
                    </div> 
