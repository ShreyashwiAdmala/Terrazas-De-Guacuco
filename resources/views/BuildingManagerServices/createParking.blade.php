    ...
    <div class="contus-container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/buildingManager/storeParking">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Apartment Type:</label><br/>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="apartmentType" value="{{old('apartmentType')}}"><br/><br/>
                        </div><br/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="ownerName" value="{{old('ownerName')}}"><br/>
                        </div>
                    ...
                    <div class="form-group row">              
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="slotId" value="{{old('slotId')}}"/><br />  
                        </div>
                    ...
                    <div class="form-group row">             
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="managerName" value="{{old('managerName')}}"/><br />
                        </div>
