...
<body>
    ...
    <div class="contus-container">
        <h2>Edit Visitor Manager Staff List</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/buildingManager/updateVisitorStaffList?email={{$email}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label"> Email Id: {{$email}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
