...
<body>
    ...
    <div class="div">
        <a href="/buildingManager/createVisitorStaffList">Create &nbsp;<i class='fa fa-plus'></i></a>
    </div>
    <div class="container1">
        <table>
            ...
            <tr>
                ...
                <td>{{$list->name}}</td>
                <td>{{$list->email}}</td>
                <td>{{$list->workerType}}</td>
                <td>{{$list->schedule}}</td>
                <td> &nbsp;<a href="/buildingManager/editVisitorStaffList?name={{$list->name}}&email={{$list->email}}&workerType={{$list->workerType}}&schedule={{$list->schedule}}"><i class='fa fa-edit' ></i></a>&nbsp;
                    <a href="/buildingManager/deleteVisitorStaffList?email={{$list->email}}"><i class='fa fa-trash-o'></i></a>
                </td>
            </tr>
            @endforeach
        </table>
