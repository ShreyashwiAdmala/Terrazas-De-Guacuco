...
<body>
    ...
    <div class="contus-container">
        <h2>Create Garden Events</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/gardenManager/storeGardenEvents">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="gardenEvents" value="{{old('gardenEvents')}}"><br/>
                        </div>
