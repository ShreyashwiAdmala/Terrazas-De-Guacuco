...
<body>
    ...
    <div class="contus-container">
        <h2>Edit Garden Events</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/gardenManager/updateGardenEvents?eventId={{$eventId}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Garden Event Id: {{$eventId}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Garden Events:</label><br />
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="gardenEvents" value="{{$gardenEvents}}"><br/>
                        </div>
                        @if ($errors->has('gardenEvents'))
                        <span class="field-error">{{ $errors->first('gardenEvents') }}</span><br/>
                        @endif
                    </div><br/>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <button type="cancel" onclick="window.location.href='{{ url('/gardenManager/gardenEvents') }}'" class="btn btn-outline-secondary btn-lg">Cancel</button>&nbsp;
                        </div>
                    </div>
                </form>
            </div>
