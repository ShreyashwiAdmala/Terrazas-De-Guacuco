...
<body>
    ...
    <div class="report-row">
        <div class="report-column">
            <img src="../images/barChartGardenManager.png" alt="report image not found" class="report-column" />
        </div>
        <div class="report-column">
            <img src="../images/pieChartGardenManager.png" alt="report image not found" class="report-column" />
        </div>
    </div>
