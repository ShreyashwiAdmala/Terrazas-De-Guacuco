  ...
  <div class="service-container3">
    <div class="service-row">
      <div class="service-column">
        <img src="../images/gardenEvents.jpeg" alt="Garden Events Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/gardenManager/gardenEvents">EVENTS</a></h2>
    ...
    <div class="service-row">
      <div class="service-column">
        <img src="../images/gardenTime.webp" alt="Pool Event Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/gardenManager/gardenTimings">Garden Timings</a></h2>
    ...
    <div class="service-row">
      ...
      <div class="service-column2">
        <h2><a href="/gardenManager/gardenAdvertisements">Advertising for Events</a></h2>
        <p>Manage and advertise various events conducted in the building</p>
      </div>
    </div>
    <div class="service-row">
      <div class="service-column">
        <img src="../images/staff-gm.png" alt="Staff List image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/gardenManager/staffList">STAFF</a></h2>
    ...
    <div class="service-row">
      <div class="service-column">
        <img src="../images/manageresidents-gm.jpeg" alt="Staff Portal Image not Found" class="image-service">
      </div>
      <div class="service-column2">
    ...
    <div class="service-row">
      <div class="service-column">
        <img src="../images/dashboard.png" alt="Staff Portal Image not Found" class="image-service">
      </div>
      <div class="service-column2">
        <h2><a href="/gardenManager/report">Dashboard</a></h2>
