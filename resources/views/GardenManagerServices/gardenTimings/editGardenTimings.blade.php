...
<body>
    ...
    <div class="contus-container">
        <h2>Edit Garden Timings</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/gardenManager/updateGardenTimings?name={{$name}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Garden Tag Name: {{$name}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <button type="cancel" onclick="window.location.href='{{ url('/gardenManager/gardenTiming') }}'" class="btn btn-outline-secondary btn-lg">Cancel</button>&nbsp;
                        </div>
                    </div>
                </form>
            </div>
