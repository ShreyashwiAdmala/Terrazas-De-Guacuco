    ...
    <div class="contus-container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/poolManager/updatepoolEvents?eventId={{$eventId}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Pool Event Id: {{$eventId}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Pool Events:</label><br />
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="poolEvents" value="{{$poolEvents}}"><br/>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <button type="cancel" onclick="window.location.href='{{ url('/poolManager/poolEvents') }}'" class="btn btn-outline-secondary btn-lg">Cancel</button>&nbsp;
                        </div>
                    </div>
                </form>
            </div>
