...
<body>
    ...
    <div class="div">
        <a href="/poolManager/createPoolEvents">Create &nbsp;<i class='fa fa-plus'></i></a>
    </div>
    <div class="container1">
        <table>
            ...
            <tr>
                ...
                <td>{{$poolEvent->status}}</td>
                <td> &nbsp;<a href="/poolManagaer/editpoolEvents?poolEvents={{$poolEvent->poolEvents}}&eventId={{$poolEvent->eventId}}&matchDate={{$poolEvent->matchDate}}&time={{$poolEvent->time}}&status={{$poolEvent->status}}"><i class='fa fa-edit' ></i></a>&nbsp;
                    <a href="/poolManager/deletePoolEvents?eventId={{$poolEvent->eventId}}"><i class='fa fa-trash-o'></i></a>
                </td>
            </tr>
            @endforeach
        </table>
