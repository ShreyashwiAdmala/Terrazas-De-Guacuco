    ...
    <div class="service-container3">
      <div class="service-row">
        <div class="service-column">
          <img src="../images/profile-visitor.jpeg" alt="Profile Image not Found" class="image-service">
        </div>
        <div class="service-column2">
          <h2><a href="/resident/myProfile">MY PROFILE</a></h2>
      ...
      <div class="service-row">
        <div class="service-column">
          <img
            src="https://media.istockphoto.com/id/1160053576/vector/car-maintenance-list-icon-car-with-check-list.jpg?s=612x612&w=0&k=20&c=el5TF6402y_zOOdfgW0obJ46cZc4UgXKiDN308gUL9A="
            alt="Profile Image not Found" class="image-service">
        </div>
        <div class="service-column2">
          <h2><a href="/resident/vehicleRegistration">Register Vechicle</a></h2>
      ...
      <div class="service-row">
        <div class="service-column">
          <img src="../images/payments.png" alt="Payments Image not Found" class="image-service">
        </div>
        <div class="service-column2">
          <h2><a href="/resident/paymentHistory">MY PAYMENTS</a></h2>
          <p>"My Payments" allows residents to make payments, track their payment history, etc.</p>
        </div>
      </div>
      <div class="service-row">
        <div class="service-column">
          <img src="../images/subscription.png" alt="subscription Image not found" class="image-service">
        </div>
        <div class="service-column2">
          <h2><a href="/resident/subcriptions">MY SUBSCRIPTIONS</a></h2>
      ...
      <div class="service-row">
        <div class="service-column">
          <img src="../images/navigation.jpeg" alt="Navigation Image not found" class="image-service">
        </div>
        <div class="service-column2">
