...
<nav class="nav-bar">
    ...
    <div class="container1">   
        <form method="post" action="/resident/storeVehicleRegistration">
            @csrf
            <label>Enter Vehicle Make:</label><br/>
            <input type="text" name="make" value="{{old('make')}}"><br/>
            <label>Enter Vehicle Model:</label><br />
            <input type="text" name="model" value="{{old('model')}}"><br/>
            <label>Enter License Plate Number:</label><br />
            <input type="text" name="licensePlate" value="{{old('licensePlate')}}"><br/>
