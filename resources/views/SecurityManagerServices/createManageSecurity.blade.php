    ...
    <div class="contus-container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/SecurityManagerServices/storeManageSecurity">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Age:</label><br />
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="age" value="{{old('age')}}"/><br /> 
                            @if ($errors->has('age'))
                        <span class="field-error">{{ $errors->first('age') }}</span><br/>
                        @endif  
                        </div>
