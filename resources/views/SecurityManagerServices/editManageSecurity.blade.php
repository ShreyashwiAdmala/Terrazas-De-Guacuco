    ...
    <div class="contus-container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/SecurityManagerServices/updateManageSecurity?emailId={{$emailId}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Pool Email Id: {{$emailId}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <button type="cancel" onclick="window.location.href='{{ url('/SecurityManagerServices/manageSecurity') }}'" class="btn btn-outline-secondary btn-lg">Cancel</button>&nbsp;
                        </div>
                    </div>
                </form>
            </div>
