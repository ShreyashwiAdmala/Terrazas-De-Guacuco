    ...
    <div class="card">
        <div class="card-inner">
            <div class="card-front">
                <img src="../images/studiosApt.jpeg" alt="Cabin APT image not found" class="apt-image">
                <p><span class="superAdmin-span "><a
                            href="/apartmentManager/Studio/residentList">Studios</a></span></p>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-inner">
            <div class="card-front">
                <img src="../images/townHouseApt.jpeg" alt="Cabin APT image not found" class="apt-image">
                <p><span class="superAdmin-span "><a
                            href="/apartmentManager/TownHouse/residentList">Town Houses</a></span></p>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-inner">
            <div class="card-front">
                <img src="../images/cabinApt.webp" alt="Cabin APT image not found" class="apt-image">
                <p><span class="superAdmin-span"><a
                            href="/apartmentManager/Cabin/residentList">Cabins</a></span></p>
            </div>
        </div>
    </div>
    <div class="footer">
