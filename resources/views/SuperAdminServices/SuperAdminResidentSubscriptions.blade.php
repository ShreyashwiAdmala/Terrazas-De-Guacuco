                ...
                <div class="container1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>{{$subResident->name}}</td>
                            <td>{{$subResident->emailId}}</td>
                            <td>{{$subResident->poolSubcription}}</td>
                            <td>{{$subResident->gardenSubcription}}</td>
                            <td>{{$subResident->tennisSubcription}}</td>
                        </tr>
                        @endforeach
                    </table>
                </div>
