...
<body>
    ...
    <div class="contus-container">
        <h2>Create Tennis Events</h2>
    </div>
        <br /><br /><br/>
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/tennisManager/storeTennisEvents">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="tennisEvents" value="{{old('tennisEvents')}}"><br/>
                        </div>
