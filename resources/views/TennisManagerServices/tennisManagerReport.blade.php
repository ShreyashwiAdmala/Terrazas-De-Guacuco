...
<body>
    ...
    <!-- <div class="report-row">
        <div class="report-column">
            <img src="../images/barChartTennisManager.png" alt="report image not found" class="report-column" />
        </div>
        <div class="report-column">
            <img src="../images/pieChartTennisManager.png" alt="report image not found" class="report-column" />
        </div>
    </div> -->
    <div class="report-data">
        <h3>Get to know more about people who have Subscribed to tennis Events</h3>
    </div>
