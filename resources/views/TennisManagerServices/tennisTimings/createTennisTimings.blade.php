...
<body>
    ...
    <!-- <div class="container">
        <h2>Create Tennis Timings</h2>
    </div> -->
    <!-- <div class="container1">   
        <form method="post" action="/tennisManager/storeTennisTimings">
            @csrf
            <label>Enter Tag Name:</label><br/>
            <input type="text" name="name" value="{{old('name')}}"><br/>
            <label>Enter Data:</label><br />
            <input type="text" name="data" value="{{old('data')}}"><br/>
            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/tennisManager/storeTennisTimings">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Tag Name:</label><br/>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="data" value="{{old('data')}}"><br/>
                        </div>
                        @if ($errors->has('data'))
