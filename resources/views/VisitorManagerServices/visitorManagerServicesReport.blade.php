...
<body>
    ...
    <div class="report-row">
        <div class="report-column">
            <img src="../images/barChartVisitorManager.png" alt="report image not found" class="report-column" />
        </div>
        <div class="report-column">
            <img src="../images/pieChartVisitorManager.png" alt="report image not found" class="report-column" />
        </div>
    </div>
    <div class="report-data">
        <h3>Get to know more about visitors who have Subscribed to Events(Pool, Garden, Tennis)</h3>
    </div>
    <div class="table-responsive">
        <table>
            ...
            <tr>
                ...
                @foreach($subVisitor as $subVisitor)
                    <tr>
                            <td><?php $counter=$counter+1; echo $counter ?></td>
                            <td>{{$subVisitor->name}}</td>
                            <td>{{$subVisitor->emailId}}</td>
                            <td>{{$subVisitor->poolSubcription}}</td>
                            <td>{{$subVisitor->gardenSubcription}}</td>
                            <td>{{$subVisitor->tennisSubcription}}</td>
                    </tr>
                @endforeach
        </table>
    </div>
