...
<body>
  ...
  <div class="subcription-image">
    ...
    <ul>
      <li>Pool Subscription:&nbsp; {{$subVisitor->poolSubcription}}</li>
      <li>Garden Subscription:&nbsp;{{$subVisitor->gardenSubcription}}</li>
      <li>Tennis Subscription:&nbsp;{{$subVisitor->tennisSubcription}}</li>
    </ul>
    @endforeach
    <span class="subcription-heading">To subcribe/unsubcribe on any of the above events refer this link -> </span>
      <a class="subcription-heading" href="/visitor/eventSubcription">Subcriptions</a>
    </span>
  </div>
  <div class="footer">
