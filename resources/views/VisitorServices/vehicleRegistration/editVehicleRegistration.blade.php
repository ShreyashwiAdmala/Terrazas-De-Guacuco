    ...
    <div class="contus-container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10">
                <form method="post" action="/visitor/updateVehicleRegistration?licensePlate={{$licensePlate}}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">License Plate: {{$licensePlate}}</label><br/>
                    </div><br/>
                    <div class="form-group row">
                        <label for="exampleInputEmail1" class="col-sm-4 col-form-label">Enter Vehicle Make:</label><br />
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="make" value="{{$make}}"><br/>
                        </div>
                        @if ($errors->has('make'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="model" value="{{$model}}"/><br /> 
                        </div>
                        @if ($errors->has('model'))
